...
3. Launch the Quake Live server container: `sudo docker run -p 27961:27960/udp 28961:28960/tcp --link redis -d --name ql -e name="Test Server" -e admin="76561198164603127" illusionld/ql-docker`
